defmodule RumblWeb.Accounts.UserControllerTest do
  use RumblWeb.ConnCase

  alias Rumbl.Accounts

  @create_attrs %{name: "some name", password: "some password", password_hash: "some password_hash", username: "some username"}
